! function (t, e) {
    ...
    e.InteractionManager = function () {}, i.Utils = {
        ...
        extend: function () {
            var t, e, s, n, r, o, a = arguments[0] || {}, h = 1,
                l = arguments.length,
                c = !1;
    ...
    return e.WebGLRenderGroup.prototype.handleFilterBlock = function (t, i) {
        ...
        bitmapFont: function (t, i, s) {
            ...
            var n = e.TextureCache[s],
                r = {}, o = i.getElementsByTagName("info")[0],
...
DEBUG = !1, SPEED = 160, GRAVITY = 1100, FLAP = 320, SPAWN_RATE = 1 / 1200, OPENING = 100, SCALE = 1, HEIGHT = 384, WIDTH = 288, GAME_HEIGHT = 336, GROUND_HEIGHT = 64, GROUND_Y = HEIGHT - GROUND_HEIGHT, parent = document.querySelector("#screen"), gameStarted = void 0, gameOver = void 0, deadTubeTops = [], deadTubeBottoms = [], deadInvs = [], bg = null, tubes = null, invs = null, bird = null, ground = null, score = null, scoreText = null, instText = null, gameOverText = null, flapSnd = null, scoreSnd = null, hurtSnd = null, fallSnd = null, swooshSnd = null, tubesTimer = null, floor = Math.floor, main = function () {
    ...
    h = function (t, e) {
        ...
        var t;
        gameOver = !0, bird.body.velocity.y > 0 && (bird.body.velocity.y = 100), bird.animations.stop(), bird.frame = 1, instText.setText("ТЫКНИ\nЧТОБЫ ПОВТОРИТЬ"), instText.renderable = !0, t = window.localStorage.getItem("hiscore"), t = t ? t : score, t = score > parseInt(t, 10) ? score : t, window.localStorage.setItem("hiscore", t), gameOverText.setText("ТЫ ПРОИГРАЛ\n\nЛУЧШИЙ РЕЗУЛЬТАТ\n\n" + t), gameOverText.renderable = !0, tubes.forEachAlive(function (t) {
            t.body.velocity.x = 0
        ...
        gameStarted = !1, gameOver = !1, score = 0, scoreText.setText("СПЕЦИАЛЬНО\nДЛЯ НАДИ И ВИКИ"), instText.setText("тыкни, чтобы begin"), gameOverText.renderable = !1, bird.body.allowGravity = !1, bird.reset(.3 * s.world.width, s.world.height / 2), bird.angle = 0, bird.animations.play("fly"), tubes.removeAll(), invs.removeAll()
    }, c = function () {
    ...
    google: {
        families: ["Press+Start+2P::cyrillic"]
    },
    active: main
},
function () {
